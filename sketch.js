...
//Draw rows and columns
  ...
  drawRow(0, 0, rectWidth, rectHeight,
    [yellow, yellow, grey, blue, yellow, yellow, blue, yellow, yellow, yellow, blue, yellow, grey, yellow, red, yellow, yellow, red,
      ...
      yellow, yellow, yellow, blue, grey, red, yellow, yellow], rowStartTime);
  drawRow(0, canvasSize * 0.06, rectWidth, rectHeight,
    [yellow, yellow, grey, red, yellow, yellow, blue, yellow, yellow, grey, yellow, red, yellow, yellow, grey, yellow, yellow, blue, yellow,
      ...
      yellow, blue, yellow, yellow, yellow, red, grey, yellow, red], rowStartTime + 500);
  drawRow(canvasSize * 0.058, canvasSize * 0.165, rectWidth, rectHeight,
    [red, yellow, red, yellow, yellow, grey, yellow, blue, yellow, yellow, grey, yellow, yellow, blue, yellow, red, yellow, blue, yellow,
      grey, red, grey], rowStartTime + 1000);
  drawRow(0, canvasSize * 0.125, rectWidth, rectHeight,
    [yellow, blue, yellow], rowStartTime + 1500);
  drawRow(0, canvasSize * 0.216, rectWidth, rectHeight,
    [yellow, blue, yellow], rowStartTime + 2000);
  drawRow(0, canvasSize * 0.295, rectWidth, rectHeight,
    [yellow, grey, yellow, blue, yellow, blue, yellow, yellow, red, grey, blue, yellow, yellow, yellow, grey, yellow, yellow, blue, yellow,
      ...
      yellow, red, yellow, yellow, blue, yellow, yellow, red, yellow], rowStartTime + 2500);
  drawRow(0, canvasSize * 0.386, rectWidth, rectHeight,
    [yellow, yellow, grey, red, yellow, yellow, blue, yellow, yellow, red, yellow, blue, yellow, yellow, yellow, grey, yellow, grey, yellow,
      ...
      yellow, blue, yellow, yellow, red, yellow, yellow, red, yellow], rowStartTime + 3000);
  drawRow(0, canvasSize * 0.325, rectWidth, rectHeight,
    [yellow, red, yellow], rowStartTime + 3500);
  ...
  drawRow(0, canvasSize * -0.51, rectWidth, rectHeight * 1.02,
    [yellow, blue, yellow, yellow, yellow, yellow, yellow, blue, yellow, grey, yellow, yellow, yellow, yellow, yellow, grey, yellow,
      ...
      grey, grey, yellow, yellow, yellow, grey, blue, yellow, grey, yellow, blue, grey, yellow, grey], rowStartTime + 4500);
  ...
  drawRow(0, canvasSize * -0.38, rectWidth, rectHeight,
    [yellow, red, yellow, yellow, yellow, blue, yellow, grey, grey, red, yellow, grey, yellow, blue, yellow, grey, yellow, yellow,
      ...
      yellow, yellow, grey, grey, grey, red, yellow, yellow, grey, blue, yellow], rowStartTime + 5000);
  ...
  drawRow(0, canvasSize * -0.2, rectWidth, rectHeight,
    [yellow, red, yellow, blue, yellow, grey, red, yellow, yellow, grey, blue, yellow, yellow, grey, yellow, blue, yellow, yellow, yellow,
      ...
      yellow, blue, yellow, blue, yellow, red, yellow, grey, blue, grey, yellow], rowStartTime + 5500);
  ...
  drawColumn(canvasSize * 0.022, 0, rectWidth, rectNewHeight,
    [yellow, blue, grey, yellow, yellow, blue, yellow, yellow, red, yellow, yellow, blue, yellow, red, yellow, grey, red], colStartTime);
  // second column from the left
  drawColumn(canvasSize * 0.066, 0, rectWidth, rectNewHeight,
    [red, yellow, grey, yellow, yellow, red, yellow, grey, yellow, grey, yellow, yellow, grey, yellow, yellow, yellow, yellow, blue, yellow, yellow, blue, red, yellow, yellow, grey, blue, yellow, yellow, red, yellow, grey, red, grey, red, yellow, red, grey, yellow, yellow, blue, grey, yellow, grey, red, yellow, yellow], colStartTime + 500);
  // third column from the left
  drawColumn(canvasSize * 0.132, 0, rectWidth, rectNewHeight,
    [yellow, yellow, yellow, grey, grey, blue, yellow, yellow, blue, yellow, blue, blue, yellow, red, grey, grey, blue, grey, blue, grey, red, yellow, blue, yellow, yellow, blue, yellow, yellow, blue, yellow, yellow, blue, blue, red, yellow, blue, grey, red, yellow, blue, grey, blue, grey, blue], colStartTime + 1000);
  // forth column from the left
  drawColumn(canvasSize * 0.242, 0, rectWidth, rectNewHeight,
    [red, yellow, grey, yellow, yellow, blue, yellow, blue, yellow, grey, yellow, blue, yellow, red, yellow, grey, yellow, blue, grey, yellow, blue, grey, yellow, grey, yellow, yellow, blue, yellow, red, yellow, grey, yellow, yellow, blue, yellow, red, grey, yellow, grey, blue, grey, red, yellow, blue, yellow, yellow], colStartTime + 1500);

  // first column from the right
  drawColumn(canvasSize * 0.95, 0, rectWidth, rectNewHeight,
    [red, yellow, red, grey, yellow, red, yellow, grey, blue, grey, yellow, blue, grey, yellow, red, yellow, grey, yellow, yellow, grey, red, yellow, blue, grey, yellow, red, yellow, grey, yellow, grey, yellow, yellow, red, grey, blue, yellow, yellow, red, yellow, red, yellow, grey, yellow, yellow, red, yellow, yellow], colStartTime + 2000);
  // second column from the right
  drawColumn(canvasSize * 0.912, 0, rectWidth, rectNewHeight,
    [yellow, blue, grey, yellow, grey, blue, blue], colStartTime + 2500);
  drawColumn(canvasSize * 0.912, canvasSize * 0.179, rectWidth, rectNewHeight * 0.98,
    [yellow, grey, red, red, red, grey, yellow, grey, yellow, grey, yellow, yellow, red], colStartTime + 3000);
  drawColumn(canvasSize * 0.912, canvasSize * 0.64, rectWidth, rectNewHeight,
    [red, grey, yellow, yellow, grey, grey, blue, yellow, yellow, grey], colStartTime + 3500);
  // third column
  drawColumn(canvasSize * 0.868, 0, rectWidth, rectNewHeight * 0.96,
    [red, grey, blue, grey, yellow, red, yellow, grey, yellow, grey, red, red, red, grey, yellow, blue, yellow, red], colStartTime + 4000);

  // fourth column
  drawColumn(canvasSize * 0.824, 0, rectWidth, rectNewHeight,
    [yellow, blue, grey, yellow, yellow, yellow, blue, yellow, blue, yellow, yellow, red, yellow, yellow, grey, blue, yellow, blue, yellow, grey, red, yellow, yellow, blue, yellow, red, yellow, grey, blue, grey, yellow, yellow, red, grey, blue, yellow, yellow, red, grey, blue, yellow, yellow, blue, yellow, red, yellow, grey, yellow, yellow, blue, grey, yellow], colStartTime + 4500);

  // fifth column
  drawColumn(canvasSize * 0.52, 0, rectWidth, rectNewHeight,
    [yellow, grey, red, yellow, grey, yellow, grey, red, grey, yellow, red, yellow, grey, yellow, grey, yellow, blue], colStartTime + 5000);
  drawColumn(canvasSize * 0.52, canvasSize * 0.465, rectWidth, rectNewHeight,
    [grey, yellow, yellow, blue, yellow, yellow, red, grey, yellow, yellow, grey, blue, yellow, grey, yellow, grey, yellow, yellow, red, grey, yellow, red, grey, yellow, yellow, blue, grey, yellow, yellow], colStartTime + 5500);

  // sixth column
  drawColumn(canvasSize * 0.472, 0, rectWidth, rectNewHeight,
    [red, yellow, grey, yellow, blue, red, yellow, blue, yellow, red, grey, yellow, yellow, blue, yellow, red, grey, blue, yellow, grey, yellow, red, yellow, yellow, grey, yellow, red, grey, red, grey, yellow, grey, yellow, blue, yellow, yellow, red, blue, grey, yellow, red, grey, yellow], colStartTime + 6000);

  // inner column
  drawColumn(canvasSize * 0.592, canvasSize * 0.465, rectWidth, rectNewHeight,
    [yellow, yellow, grey, yellow, red, yellow, red], colStartTime + 6500);
...
function drawRow(x, y, w, h, colors, startTime) {
  let elapsedTime = millis() - startTime;
  for (let i = 0; i < colors.length; i++) {
    let delay = i * 100; // 100ms delay between each square
